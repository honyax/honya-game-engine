...
**教養編の5日目**。Day 60 の `CpuRayTracer` の続きで、reference は Day 60 の完全コピー + 差分。
...
Day 60 の要点9 と同じ話が、GPU でさらに効いてくる——**ノイズと移植の間違いは見分けがつかない**。
...
- **Day 60 の計画書**(パストレーシングと BVH)— 移す元。要点1〜9 が今日のシェーダの中身そのもの
...
これは Day 60 の設計書で「今日残した歪み1」として挙げたものの解消にあたる。
...
**Day 60 の設計書に差分を当てたもの**。変わったのは3か所。
