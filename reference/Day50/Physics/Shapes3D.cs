...
/// <summary>
/// 軸に平行な直方体(AABB)。**3D でいちばん安い形**であり、今日の主役の片方(要点5)。
///
...
/// (Day 45 の要点3)。<b>地形そのものは凹んでいる</b>が、
...
internal readonly struct Triangle3D
{
    ...
    /// パラメータ t について凸な関数になる(Day 45 の要点3)。
    ...
    /// <summary>
    /// 真上から見たとき、この点が三角形の中に入っているか(Day 46 の要点3)。
    ///
