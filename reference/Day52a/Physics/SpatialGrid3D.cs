...
/// **総当たり O(n²) から抜けるための、いちばん単純な空間分割**(要点1〜3)。
///
...
///
/// <para>
/// <b>3D で新しく出てくる問題が1つある</b>。それが「格子に入らないもの」(要点2)。
...
internal sealed class SpatialGrid3D
{
    ...
    /// <summary>
    /// 1つの体が占めてよいマスの数の上限。**これを超えたら格子に入れない**(要点2)。
    ///
    ...
    ///
    /// <para>
    /// <b>3D で1つ増えた仕事</b>が、格子に入らないものの仕分け(要点2)。
