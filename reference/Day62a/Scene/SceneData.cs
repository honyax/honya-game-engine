...
/// </para>
/// <para>
/// 球の数を 1 / 2 / 3 キーで変えられるようにしてあるのが今日の仕掛け。
/// 今日の探し方は<b>総当たり</b>(シェーダが球を先頭から全部試す)なので、
/// 数を増やすと素直に重くなる。<b>その重さが Day 62b で消える</b>のを見るための下準備。
/// </para>
/// </summary>
internal static class SceneData
{
    /// <summary>1 / 2 / 3 キーに割り当てる球の数。</summary>
    public static readonly int[] Presets = [8, 120, 720];
