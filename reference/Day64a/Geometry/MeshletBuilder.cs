...
/// <summary>
/// メッシュレット1つ。<b>16 バイト</b>。GLSL の <c>Meshlet</c> 構造体と1バイトも違ってはいけない。
///
/// <para>
/// 中身は「どこから何個」が2組あるだけ。頂点そのものも三角形そのものも持たず、
...
internal static class MeshletBuilder
{
    ...
    /// </para>
    /// </summary>
    private static void BuildGrow(MeshData mesh, MeshletWriter writer)
    {
