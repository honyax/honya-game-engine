...
/// 設計で決めたことが4つある。
///
/// <b>1. <see cref="ResourceManager"/> に相乗りしない</b>
/// テクスチャと同じように扱えるのだから同居させたくなるが、
/// <see cref="ResourceManager"/> は <c>GL</c> を握っている。
/// そこに OpenAL を足すと「<c>Core</c> がグラフィックスと音の両方を知る」ことになり、
/// Day 25 の設計書で書いた <c>Core</c> ⇔ <c>Render</c> の相互参照を**もう一段悪くする**。
